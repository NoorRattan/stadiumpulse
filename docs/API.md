...
Crowd values in the demo deployment are explicitly simulated. Forecast math is deterministic and bounded to `0..100`; Gemini only phrases the operational narrative around the server-computed projection.
